function calculateCalories(age,height,currentWeight, desiredWeight){
   ...
   const RMB = 655 + 9.6 * numberCurrentWeight + 1.8 * numberHeight - 4.7 * numberAge;
   const neededCalories = RMB * 1.9;
   const neededCaloriesForDesiredWeight = (655 + 9.6 * numberDesiredWeight + 1.8 * numberHeight - 4.7 * numberAge) * 1.9
